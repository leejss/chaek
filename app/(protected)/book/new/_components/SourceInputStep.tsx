  ...
  return (
    <div className="space-y-8 max-w-3xl mx-auto">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold text-white mb-3">Source Material</h2>
      ...
      <div className="relative">
        <textarea
          className="w-full h-96 p-6 bg-black border border-neutral-800 rounded-2xl focus:ring-2 focus:ring-brand-600/20 focus:border-brand-600 transition-all text-lg leading-relaxed resize-none placeholder:text-neutral-600 placeholder:italic shadow-inner text-white"
          placeholder="Paste your source text here..."
          value={sourceText || ""}
          onChange={(e) => updateDraft({ sourceText: e.target.value })}
        />
        <div className="absolute bottom-4 right-4 text-xs text-neutral-500 bg-black/80 px-2 py-1 rounded">
