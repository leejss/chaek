...
export const AIProviderSchema = z.enum([getAIProvider("GOOGLE"), getAIProvider("ANTHROPIC")]);

export const GeminiModelSchema = z.enum([getGeminiModel("FLASH-3"), getGeminiModel("PRO-3")]);
...
export type BookGenerationSettings = z.infer<typeof BookGenerationSettingsSchema>;
